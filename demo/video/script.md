...
| 0:15–1:30 | live | Screen recording of the hosted demo (time-lapsed): story pasted → Ultra's shot list → Super's frames pop in → **Nano Omni critic flags a frame, revision fixes it (before/after)** → Editor lint fixes | Roles, the repair loop, the vision critic loop, live tokens and cost |
